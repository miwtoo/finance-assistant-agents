    ...
    return new FakeParser({
      result: {
        ...
        assessments: {
          ...
          parsedMerchant: { uncertain: false, confidence: 0.90 },
        },
  ...
  static partial(overrides: Partial<ParseResult> = {}): FakeParser {
    return new FakeParser({
      result: {
        ...
        confidence: "low",
        assessments: {
          currency: { uncertain: true, reason: "Currency not detected", confidence: 0.0 },
          amount: { uncertain: false, confidence: 0.85 },
        },
